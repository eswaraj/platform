...
public class ComplaintController extends BaseController{
    ...
    public @ResponseBody String saveComplaint(HttpServletRequest httpServletRequest) throws ApplicationException, IOException, ServletException {
        ...
        Long dailyUserTotalComplaints = complaintCache.getUserComplaintsForTheDay(saveComplaintRequestDto.getUserExternalid());
        ComplaintDto savedComplaintDto = complaintService.saveComplaint(saveComplaintRequestDto, dailyUserTotalComplaints);
        complaintCache.incrementPersonComplaintsForTheDay(saveComplaintRequestDto.getUserExternalid());
