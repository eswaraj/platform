...
public interface UserRepository extends GraphRepository<User>{
    ...
    @Query("start facebookAccount=node:FacebookUserIdIdx('facebookUserId: {0}') match (user)<-[:OF_USER]-(facebookAccount) where user.__type__ = 'com.eswaraj.domain.nodes.User' return user")
