    ...
    a.Dasky = function (b, c) {
        ...
        d.$el = a(b), d.$el.data("dasky", d), d._init = function (b) {
			...
			if (g) {
				...
				d.options = a.extend(!0, {}, a.Dasky.defaults, b),
				d.$steps = d.$el.children("div"), d._layout(),
				d._initJmpress(), d._loadEvents(),
			...
			d.options.nav && (d.$nav = a('<div class="dsk-nav"></div>'),
			d.$pre = a('<span class="dsk-pre"></span>').appendTo(d.$nav),
			d.$next = a('<span class="dsk-next"></span>').appendTo(d.$nav),
			d.$pause = a('<span class="dsk-autoplay"></span>').appendTo(d.$nav),
			d.$el.append(d.$nav)), d.options.fullscreen && (a("html,body").css({
                height: "100%"
            }), d.$el.css({
                height: "100%"
            }))
