                                                                        ...
                                                                        <div class="innerdiv-issue-info" >
                                                                            ...
                                                                            <div class="carousel_map_tab">
                                                                                <ul class="nav nav-tabs c_m_tab_content" id="c_m_tab{{$index + 1}}">
                                                                                    ...
                                                                                    <li><a href="#loc_on_map{{$index + 1}}" ng-click="showTab($event); is_map_tab_selected = 'true'; $event.preventDefault(); $event.stopPropagation();">Show on Map</a></li>
                                                                                </ul>
                                                                                ...
                                                                                <div class="tab-content">
                                                                                    ...
                                                                                    <div class="tab-pane" id="loc_on_map{{$index + 1}}">
                                                                                        <div ng-show="is_map_tab_selected == 'true'" class="googleMap_tabcontent">
                                                                                            <googleMap id="googleMap{{$index + 1}}" lat="{{complaint.lattitude}}" lng="{{complaint.longitude}}" class="gmap_canvas"></googleMap>
                                                                                        </div>
                                                                                    </div>
