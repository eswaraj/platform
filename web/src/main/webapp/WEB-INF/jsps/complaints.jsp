                                                ...
                                                <div class="listing-wrapper">
                                                    ...
                                                    <div class="listing">
                                                        ...
                                                        <div class="mla_unread_complaints_controller">
                                                            ...
                                                            <span class="comments_display_per_page"><b>Showing 2<span ng-repeat="item in complaints | filter:{isVisible:'true'} = (items | filter:filterExpr)"></span><span>{{complaints.length}}</span> of <span>{{complaints.length}}</span> Complaints</b></span>
                                                        </div>	
