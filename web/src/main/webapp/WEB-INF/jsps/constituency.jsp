...
<h4><i class="glyphicon glyphicon-filter"></i> Filter Issues</h4>
	...
	<div class="form-group">
		<label><input type="checkbox" name="" id=""> Show my complains only</label>
	</div>	
</div>
<!-- /.right-pane -->
<div class="listing-wrapper">
	<div class="secondary-wrapper">
	<div class="pull-left"><h1>CBD Belapur Constituency</h1></div>
	<div class="pull-right">
		<div class="btn-group">
  <button type="button" class="btn btn-default active" title="List View"><i class="glyphicon glyphicon-list"></i></button>
  <button type="button" class="btn btn-default" title="Map View"><i class="glyphicon glyphicon-map-marker"></i></button>
  <button type="button" class="btn btn-default" title="Analytical View"><i class="glyphicon glyphicon-signal"></i></button>
</div>
	</div>
