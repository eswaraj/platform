                                ...
                                <div class="outerwrapper">
                                    ...
                                    <div class="innerwrapper">
											...
											<div class="list-row">
													...
													<div class="col-sm-10 col-md-10 profile-info profile_info_adjust">
														<p class="col-sm-12 col-md-12 whom">
															<span class="col-sm-6 col-md-6 username text-limit name_adjust">
																<c:forEach items="${complaint.createdBy}" var="onePerson">
																	<a href="#!" class="anchorlink username_adjust" >${onePerson.name}</a>
																</c:forEach>
															</span>
															
															<span class="col-sm-6 col-md-6 time_info_adjust">
														...
														<span class="col-sm-6 col-md-6 address_adjust">
															<i class="glyphicon glyphicon-map-marker"></i>
															<a href="#!" class="anchorlink" ><span class="location">${complaint.locationAddress}</span></a>
														</span>

														<span class="col-sm-6 col-md-6 status_adjust">
										...
										<div class="comments-info" >
                                                ...
                                                <div id="load_comments_box"><a href="#!" id="comments_status" class="comments_controller_header">Comments from Users ( ${complaint.totalComments} )</a>
