...
$('#water_infographic_div').on('click', function(){
	...
	$('#modal-background-infographic .infographic_image').after( '<div class="addthis_toolbox addthis_floating_style  addthis_32x32_style" addthis:title="Water" addthis:description="Infographic for Water Category" addthis:url="http://www.creativebloq.com/sites/creativebloq.com/files/images/2013/04/controllersfull2.jpg" style="left:50px;top:50px;" ><a class="addthis_button_facebook"></a><a class="addthis_button_twitter"></a><a class="addthis_button_google_plusone_share" g:plusone:count="false"></a><a class="addthis_button_gmail"></a><a class="addthis_button_compact"></a><script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5461a4f33cabcdfe" async="async"></script></div>' );
...
$('#law_ord_infographic_div').on('click', function(){
	...
	$('#modal-background-infographic .infographic_image').after( '<div class="addthis_toolbox addthis_floating_style  addthis_32x32_style" addthis:title="Water" addthis:description="Infographic for Water Category" addthis:url="http://media.creativebloq.futurecdn.net/sites/creativebloq.com/files/images/2013/10/productive.jpg" style="left:50px;top:50px;" ><a class="addthis_button_facebook"></a><a class="addthis_button_twitter"></a><a class="addthis_button_google_plusone_share" g:plusone:count="false"></a><a class="addthis_button_gmail"></a><a class="addthis_button_compact"></a><script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5461a4f33cabcdfe" async="async"></script></div>' );
	$('#modal-background-infographic').fadeIn(1);
	$('.outerwrapper').fadeOut(1);
	$("#toc").fadeOut(1);
});
...
$('#electricity_infographic_div').on('click', function(){
	...
	$('#modal-background-infographic .infographic_image').after( '<div class="addthis_toolbox addthis_floating_style  addthis_32x32_style" addthis:title="Water" addthis:description="Infographic for Water Category" addthis:url="http://th07.deviantart.net/fs50/PRE/i/2009/309/8/3/Panda_Infographic_by_Lish_55.jpg" style="left:50px;top:50px;" ><a class="addthis_button_facebook"></a><a class="addthis_button_twitter"></a><a class="addthis_button_google_plusone_share" g:plusone:count="false"></a><a class="addthis_button_gmail"></a><a class="addthis_button_compact"></a><script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5461a4f33cabcdfe" async="async"></script></div>' );
	$('#modal-background-infographic').fadeIn(1);
	$('.outerwrapper').fadeOut(1);
	$("#toc").fadeOut(1);
});
...
$('#roads_infographic_div').on('click', function(){
	...
	$('#modal-background-infographic .infographic_image').after( '<div class="addthis_toolbox addthis_floating_style  addthis_32x32_style" addthis:title="Water" addthis:description="Infographic for Water Category" addthis:url="http://th05.deviantart.net/fs70/PRE/i/2010/287/5/9/typographic_elephant_by_lish_55-d30qrbr.jpg" style="left:50px;top:50px;" ><a class="addthis_button_facebook"></a><a class="addthis_button_twitter"></a><a class="addthis_button_google_plusone_share" g:plusone:count="false"></a><a class="addthis_button_gmail"></a><a class="addthis_button_compact"></a><script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5461a4f33cabcdfe" async="async"></script></div>' );
	$('#modal-background-infographic').fadeIn(1);
	$('.outerwrapper').fadeOut(1);
	$("#toc").fadeOut(1);
});
...
$('#transport_infographic_div').on('click', function(){
	...
	$('#modal-background-infographic .infographic_image').after( '<div class="addthis_toolbox addthis_floating_style  addthis_32x32_style" addthis:title="Water" addthis:description="Infographic for Water Category" addthis:url="http://media.creativebloq.futurecdn.net/sites/creativebloq.com/files/images/2014/04/font-infography.jpg" style="left:50px;top:50px;" ><a class="addthis_button_facebook"></a><a class="addthis_button_twitter"></a><a class="addthis_button_google_plusone_share" g:plusone:count="false"></a><a class="addthis_button_gmail"></a><a class="addthis_button_compact"></a><script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5461a4f33cabcdfe" async="async"></script></div>' );
	$('#modal-background-infographic').fadeIn(1);
	$('.outerwrapper').fadeOut(1);
	$("#toc").fadeOut(1);
});
