                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="heading">
                            ...
                            <div class="for-user">
                                ...
                                <button type="button" class="btn btn-primary btn-lg"> <i class="icomoon icomoon-facebook"></i>
                                </button>
                                <button type="button" class="btn btn-primary btn-lg"> <i class="icomoon icomoon-twitter"></i>
                                </button>
                            </div>
                            -->
                            <div class="btn-group" onclick="location.href='05-constituency.php';">
                                <button type="button" class="btn btn-primary btn-lg" onclick="location.href='05-constituency.php';">
                                    <i class="icomoon icomoon-facebook"></i>
                                </button>
                                <button type="button" class="btn btn-primary btn-lg">Log in with Facebook</button>
                            </div>
                            <!-- <br>
                            <br>
                            <div class="btn-group">
                            ...
                            <a href="#know-more" class="btn btn-primary btn-lg scroll-to">Know More</a>
                            <br>
                            <br>
                            <div class="btn-group">
                                <button type="button" class="btn btn-primary btn-lg">Sign Up</button>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse">
                            <ul class="nav navbar-nav">
                                <li>
                                    <a class="scroll-to" href="#landing-screen">Download</a>
                                </li>
                                <li class="active">
                                    <a href="#know-more" class="scroll-to">Know More</a>
                                </li>
                                <li>
                                    <a class="scroll-to" href="#team">Team</a>
                                </li>
                            </ul>
                        ...
                        <li>
                            <div class="btn-group" onclick="location.href='05-constituency.php';">
                                ...
                                <button type="button" class="btn btn-primary btn-sm">Log in with Facebook</button>
                            </div>
                        </li>
                    </ul>
                </div>
