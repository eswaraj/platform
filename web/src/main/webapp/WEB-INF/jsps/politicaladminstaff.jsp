...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-9">
		    ...
		    <div>
			    <h1>Add new Staff</h1>
			    <typeahead items="items" prompt="Start typing a name" title="name" subtitle="biodata" img="profilePhoto" min="3" url="/ajax/person/search/name/" querystring="term" model="selected" on-select="onPersonSelected()" />
