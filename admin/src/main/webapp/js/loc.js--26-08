...
var selected_node =  $('#js_tree').jstree('get_selected');
  $.ajax({
    type: 'post',
    url: 'http://dev.admin.eswaraj.com/eswaraj-web/ajax/location/'+selected_node[0]+'/upload',
    data: file,
	headers: {
...
var form = document.getElementById("form1");
            form.onsubmit = function(){
				...
				var selected_node =  $('#js_tree').jstree('get_selected');
           var  kml_url= 'http://dev.admin.eswaraj.com/eswaraj-web/ajax/location/'+selected_node[0]+'/upload'
