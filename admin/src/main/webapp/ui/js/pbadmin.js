        ...
        success: function(data){
            if(data){
                $.ajax({
                    ...
                    success: function(d){
                        if(d){
                            $('#pbadmin_list_current').append('<p>'+d.name+'</p><input type="button" class="admin_edit" onclick="showEdit(event)" location_id="'+locationId+'" pbtype_id="'+pbtypeId+'" value="Edit">Edit</input>');
                        }
                    }
                });
            }
