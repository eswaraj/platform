...
public class TestAppServiceImpl_Category extends BaseNeo4jEswarajTest{
	...
	/**
	 * Test when parent category Id do not exists and we call getAllChildCategoryOfParentCategory
	 * It should throw Application Exception
	 * @throws ApplicationException 
	 */
	@Test(expected=ApplicationException.class)
	public void test09_getAllChildCategoryOfParentCategory() throws ApplicationException{
		appService.getAllChildCategoryOfParentCategory(randomPositiveLong());//should throw Application Exception
	}
}
